                            ...
                            <div key={shipment.id} className="glass-card p-6 hover:shadow-2xl transition-all duration-300 animate-slide-in" style={{ animationDelay: `${index * 0.1}s` }}>
                                ...
                                <div className="grid grid-cols-2 gap-4 mb-4 p-4 bg-gray-50 rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm font-semibold text-gray-900">{shipment.driver || 'Unassigned'}</p>
                                    </div>
                                    <div>
                                        <p className="text-xs text-gray-500">Vehicle</p>
                                        <p className="text-sm font-semibold text-gray-900">{shipment.vehicle_id || 'Unassigned'}</p>
                                    </div>
                                </div>
